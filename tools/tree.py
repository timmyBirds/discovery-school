...
parts = [
    ...
    '<path d="M190 600 C176 604 166 608 154 608" stroke-width="5"/>',
    ...
    '<path d="M325 521 C285 545 242 552 198 556" stroke-width="6"/>',
...
for name, (shades, colour, (cx, cy), r, (lx, ly), anchor) in VALUES.items():
    ...
    parts.append('</g>')
parts.append(f'<g font-family="Fraunces, Georgia, serif" font-weight="700" fill="{BARK}" text-anchor="middle" stroke="#fff" stroke-width="8" stroke-linejoin="round" paint-order="stroke">')
...
parts.append('<text x="84" y="598" font-size="28" letter-spacing="2">ROOTED</text>')
parts.append('<text x="84" y="626" font-size="22">IN</text>')
parts.append('<text x="84" y="658" font-size="28" letter-spacing="2">CHRIST</text>')
parts.append('</g>')
parts.append('</svg>')
